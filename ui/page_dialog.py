from PySide6.QtWidgets import (
    ...
    QComboBox, QDialogButtonBox, QScrollArea, QWidget
)
...
class PageDialog(QDialog):
    ...
    def _build_ui(self):
        ...
        self.menu_order_edit = QLineEdit()
        self.menu_order_edit.setPlaceholderText("0")
        form.addRow("Orden en menú:", self.menu_order_edit)
    ...
    def _populate(self, page):
        ...
        self.menu_order_edit.setText(str(page.get("menu_order", "") or ""))
    ...
    def get_data(self):
        ...
        order = self.menu_order_edit.text().strip()
        if order.lstrip("-").isdigit():
            data["menu_order"] = int(order)
